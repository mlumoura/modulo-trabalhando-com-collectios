...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        ...
        System.out.println("Temperaturas do Semestre: " + temperaturasSemestral);
        System.out.println("Média temperaturas do Semestre: " + mediaTemperaturasSemenstral + "oC");
        System.out.println("----------");

        for (Double temp : temperaturasSemestral) { // AQUI EU PEGO A TEMPERATURA E JOGO EM TEMP
            if(temp > mediaTemperaturasSemenstral) {
                int index = temperaturasSemestral.indexOf(temp);
                // o índice corresponde ao mes, lembrando que começa por 0
                // lembrar que os dados foram inserios 1 por mes (1 A 6)
                switch (index) {
                    case 0:
