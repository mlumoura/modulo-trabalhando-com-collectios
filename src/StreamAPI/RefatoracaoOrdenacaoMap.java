...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        // O exemplo acima, com lambda e ComparinInt
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(Comparator.comparingInt(cont
                -> cont.getValue().getNumero()));
        // Exemplo acima com lambda somente
        Set<Map.Entry<Integer, Contato>> exemploset = new TreeSet<>((cont1, cont2)
                -> Integer.compare(cont1.getValue().getNumero(), cont2.getValue().getNumero()));

        // Usando o método estático do Comparator => Comparing
        ...
        // Simplificar ainda mais usando o Lambda
