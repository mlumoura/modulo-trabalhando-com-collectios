...
//        System.out.println("Pegue os 5 primeiros números e coloque dentro de um Set:");
        // Vai imprimir somente 4 números porque o set não aceita duplicata
        numerosAleatorios.stream()
                .limit(5)
                .collect(Collectors.toSet())
                .forEach(System.out::println);

        // Se eu não quisesse imprimir e guardar em um Set
       ...
       // Usando lambda com metodo de referência
       numerosAleatorios.stream()
               .map(Integer::parseInt)
               .forEach(System.out::println);
       ...
       System.out.println("Pegue os números pares e maiores que 2 e coloque em uma lista:");
        ...
        /*numerosAleatorios1.stream()
                .average() // => Dá erro: Não pode resolver o método average no Stream
