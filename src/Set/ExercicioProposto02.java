...
public class ExercicioProposto02 {
    public static void main(String[] args) {
        Set<LinguagemFavorita> minhasLinguagensFavoritas = new HashSet<>(); // Inserção desordenada
        ...
        Set<LinguagemFavorita> minhasLinguagensFavoritas1 = new LinkedHashSet<>( // Por ordem de inserção
                Arrays.asList(
        ...
        // Vai imprimir uma debaixo da outra
        for (LinguagemFavorita linguagem : minhasLinguagensFavoritas1) System.out.println(linguagem);

        System.out.println("--------\tOrdem Natural: Nome\t--------"); // Ordem Natural = TreeSet
...
//  Classes para comparação

// Tenho que criar essa classe para usar no Set
...
class LinguagemFavorita implements Comparable<LinguagemFavorita> {
    ...
    // Comparable força sobrescrever o toString
    @Override
    ...
    // Comparable força sobrescrever o compareTo
    @Override
    public int compareTo(LinguagemFavorita linguagemFavorita) {
        return this.nome.compareTo(linguagemFavorita.nome);
    }

    // Comparable força sobrescrever o equals() e hashCode()
    @Override
...
// Vou estar comparando elementos
